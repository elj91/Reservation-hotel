        ...
        <table class="table table-bordered" id="table-data">
            <thead>
                <tr>
                    ...
                    <th scope="col">Location de chambre</th>
                    <th scope="col">Location de lit</th>
            ...
            ?>
                <tr>
                    ...
                    <td class="action">
                        <a href="invoiceprint.php?id= <?php echo $res['id']?>"><button class="btn btn-primary"><i class="fa-solid fa-print"></i>Imprimer</button></a>
						<a href="paymantdelete.php?id=<?php echo $res['id']?>"><button class="btn btn-danger">Supprimer</button></a>
                    </td>
                </tr>
            <?php
            }
