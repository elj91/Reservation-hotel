...
<body>
    <div class="addroomsection">
        <form action="" method="POST">
            <label for="troom">Type de chambres :</label>
            ...
            <label for="bed">Type de lit :</label>
            <select name="bed" class="form-control">
                ...
                <option value="Triple">Aucun</option>
            </select>

            <button type="submit" class="btn btn-success" name="addroom">Ajouter chambres</button>
        </form>
