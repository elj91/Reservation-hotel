...
<body>
    <div class="addroomsection">
        <form action="" method="POST">
            <label for="troom">Nom :</label>
            <input type="text" name="staffname" class="form-control">

            <label for="bed">Poste :</label>
            <select name="staffwork" class="form-control">
                <option value selected></option>
                <option value="Manager">Manager</option>
                <option value="Cook">Cuisiner</option>
                <option value="Helper">Personnel</option>
                <option value="cleaner">Ménage</option>
                <option value="weighter">Sécurité</option>
            </select>

            <button type="submit" class="btn btn-success" name="addstaff">Ajouter chambres</button>
        </form>
