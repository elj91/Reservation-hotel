    ...
    <section id="auth_section">
        ...
        <div class="auth_container">
            ...
            <div id="Log_in">
                <h2>Se connecter</h2>
                <div class="role_btn">
                    <div class="btns active">Utilisateur</div>
                ...
                <form class="user_login authsection active" id="userlogin" action="" method="POST">
                    ...
                    <button type="submit" name="user_login_submit" class="auth_btn"> Se connecter</button>

                    <div class="footer_line">
                        <h6>Vous n'avez pas de compte ? <span class="page_move_btn" onclick="signuppage()"> S'incrire</span></h6>
                    </div>
                </form>
                ...
                <form class="employee_login authsection" id="employeelogin" action="" method="POST">
                    ...
                    <button type="submit" name="Emp_login_submit" class="auth_btn">Se connecter</button>
                </form>
            ...
            <div id="sign_up">
                ...
                <form class="user_signup" id="usersignup" action="" method="POST">
                    ...
                    <button type="submit" name="user_signup_submit" class="auth_btn"> S'inscrire</button>

                    <div class="footer_line">
                        <h6>Vous avez déjà un compte? <span class="page_move_btn" onclick="loginpage()"> Se connecter</span></h6>
                    </div>
                </form>
            </div>
    </section>
